...
describe("trusted contact form tests", () => {
  let utils: RenderResult;
  beforeEach(() => {
    utils = render(<Route component={TrustedContactForm} />, {
      route: "/yieldx/investors/create/trusted-contact"
    });
  });

  afterEach(() => jest.clearAllMocks());

  test("should render trusted contact form", async () => {
