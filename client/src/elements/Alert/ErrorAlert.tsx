...
export default function ErrorAlert({ message, bottomNav }: Props) {
  return (
    <Container
      className={clsx("container-fluid", { bottomNav })}
      color="#FF5252"
    >
      <svg
        width="22"
      ...
      <span>
        {message || "We could not process your inputs. Please try again."}
      </span>
    </Container>
  );
}
