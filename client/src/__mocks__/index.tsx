...
import mockAnalysis from "./models/mockAnalysis";
import mockAssets from "./models/mockAssets";
import mockYieldXPortfolio from "./models/mockYieldXPortfolio";
import fund from "./models/assets/fund";
import muni from "./models/assets/muni";

export const inpaasFormState = atom<{
